#!/usr/bin/env bun
/**
 * adeel-global-discover — Discover AI coding sessions across Claude Code, Codex CLI, and Gemini CLI.
 ...
 *
 * Usage:
 *   adeel-global-discover --since 7d [--format json|summary]
 *   adeel-global-discover --help
 */
...
function printUsage(): void {
  console.error(`Usage: adeel-global-discover --since <window> [--format json|summary]
...
Examples:
  adeel-global-discover --since 7d
  adeel-global-discover --since 14d --format summary`);
}
...
function resolveClaudeCodeCwd(
  ...
  // e.g., -Users-user-git-repo → /Users/user/git/repo
