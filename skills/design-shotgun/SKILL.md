...
"This is /adeel:design-shotgun — your visual brainstorming tool. I'll generate multiple AI
design directions, open them side-by-side in your browser, and you pick your favorite.
You can run /adeel:design-shotgun anytime during development to explore design directions for
...
1. **Never save to `.context/`, `docs/designs/`, or `/tmp/`.** All design artifacts go
   to `$HOME/.adeel/projects/$SLUG/designs/`. This is enforced. See DESIGN_SETUP above.
