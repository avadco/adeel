...
Shared reference for the canonical TODOS.md format. Referenced by `/adeel:ship` (Step 5.5) and `/adeel:plan-ceo-review` (TODOS.md updates section) to ensure consistent TODO item structure.
