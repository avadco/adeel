...
- Options presented with only human-team effort estimates — should show both human and CC+adeel time
...
This heuristic is referenced by both `/adeel:review` and `/adeel:ship`. It determines whether
