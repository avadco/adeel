...
**Trigger:** Only run this checklist if the diff touches frontend files. Use `adeel-diff-scope` to detect:
...
- **[LOW]** — Requires understanding visual intent. Present as: "Possible issue — verify visually or run /adeel:design-review."
...
**LOW confidence items** → present as "Possible: [description]. Verify visually or run /adeel:design-review." Never AUTO-FIX.
...
- [file:line] Possible issue — verify with /adeel:design-review
```
