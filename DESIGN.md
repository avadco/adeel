...
## Product Context
- **What this is:** Community website for adeel — a CLI tool that turns Claude Code into a virtual engineering team
- **Who it's for:** Developers discovering adeel, existing community members
...
|------|----------|-----------|
| 2026-03-21 | Initial design system | Created by /adeel:design-consultation. Industrial aesthetic, warm amber accent, Satoshi + DM Sans + JetBrains Mono. |
