...
Today, `/adeel:qa` and `/adeel:design-review` feel like a black box. Claude says "I found 3 issues" but you can't see what it's looking at. With the sidebar connected to Conductor:
...
## What's already built (adeel side)
...
**Estimated effort:** 2-3 days Conductor engineering, 1 day adeel integration.
