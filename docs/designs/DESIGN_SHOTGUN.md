...
Branch: user/agent-design-tools
...
- Shows: "Want to make more changes? Run `/adeel:design-shotgun` again."
...
- Shows: "Run `/adeel:design-shotgun` again in your coding agent."
...
5. $D serve writes board HTML with injected __ADEEL_SERVER_URL
...
| HTML injection of server URL | __ADEEL_SERVER_URL check | `serve.test.ts` |
