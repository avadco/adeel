...
- The report MUST exist at ${reportPath} when you finish`,
    ...
    if (!report) {
      ...
      recordE2E(evalCollector, `/adeel:qa ${label}`, 'Planted-bug outcome evals', result, { error: 'no report generated' } as any);
    ...
    recordE2E(evalCollector, `/adeel:qa ${label}`, 'Planted-bug outcome evals', result, {
