...
export const E2E_TOUCHFILES: Record<string, string[]> = {
  ...
  // Ship
  'ship-base-branch': ['ship/**', 'bin/adeel-repo-mode'],
  ...
  // Global discover
  'global-discover':   ['bin/adeel-global-discover.ts', 'test/global-discover.test.ts'],
  ...
  // Codex (Claude E2E — tests /adeel:codex skill via Claude)
  'codex-review': ['codex/**'],
  ...
  'codex-review-findings': ['review/**', '.agents/skills/adeel-review/**', 'codex/**', 'test/helpers/codex-session-runner.ts', 'lib/worktree.ts'],
  ...
  'gemini-review-findings': ['review/**', '.agents/skills/adeel-review/**', 'test/helpers/gemini-session-runner.ts', 'lib/worktree.ts'],


  // Coverage audit (shared fixture) + triage + gates
  'ship-coverage-audit': ['ship/**', 'test/fixtures/coverage-audit-fixture.ts', 'bin/adeel-repo-mode'],
  ...
  'ship-triage': ['ship/**', 'bin/adeel-repo-mode'],
  ...
  // adeel-upgrade
  'adeel-upgrade-happy-path': ['adeel-upgrade/**'],

  // Deploy skills
  'land-and-deploy-workflow':      ['land-and-deploy/**', 'scripts/gen-skill-docs.ts'],
  'land-and-deploy-first-run':     ['land-and-deploy/**', 'scripts/gen-skill-docs.ts', 'bin/adeel-slug'],
  'land-and-deploy-review-gate':   ['land-and-deploy/**', 'bin/adeel-review-read'],
...
export const LLM_JUDGE_TOUCHFILES: Record<string, string[]> = {
  ...
  'adeel-upgrade/SKILL.md upgrade flow': ['adeel-upgrade/SKILL.md', 'adeel-upgrade/SKILL.md.tmpl'],
